...
export default function Contact() {
  return (
    ...
    >
      ...
      <button className="w-full rounded-xl bg-blue-950 from-blue-950  to-gradientColorBlue py-5 text-slate-50 duration-200 hover:scale-95 hover:bg-gradient-to-r md:w-8/12 md:py-7 lg:w-1/2 ">
